...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = mLifecycleCallbacks.size() - 1; i >= 0; i--) { // I had i > 0 originally - missing 1 item each time.
            String s = mLifecycleCallbacks.get(i) + "\n";
//                    mLifecycleDisplay.setText(s); //  this is the main error - overwriting all
