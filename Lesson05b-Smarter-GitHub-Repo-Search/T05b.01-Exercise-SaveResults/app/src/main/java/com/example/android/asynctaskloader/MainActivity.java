...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SEARCH_QUERY_URL = "searchQueryUrl";

    // TODO completed (2) Create a static final key to store the search's raw JSON
    private static final String SEARCH_RESULTS_RAW_JSON = "searchResultsRawJson";
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(SEARCH_QUERY_URL, urlString);
        ...
        outState.putString(SEARCH_RESULTS_RAW_JSON, rawJsonString);
